...
```bash
CODEX_OVERLEAF_REF=v2.3.1 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.3.1/install.sh)"
```

Windows PowerShell:

```powershell
iwr https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.3.1/install.ps1 -OutFile install.ps1
$env:CODEX_OVERLEAF_REF='v2.3.1'
...
```bash
npm exec --yes codex-overleaf-link@2.3.1 -- install-managed
```
...
| Action | Command |
|--------|---------|
| Install / update | `npm exec --yes codex-overleaf-link@2.3.1 -- install-managed` |
| Diagnose | `npm exec --yes codex-overleaf-link@2.3.1 -- doctor` |
| Uninstall | `npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed` |
...
The v2.3.1 GitHub Release contains:

- `codex-overleaf-link-extension-v2.3.1.zip`: loadable Chrome extension package for manual unpacked installation.
- `codex-overleaf-native-host-v2.3.1.tar.gz`: native host runtime files used by the installer and release verification.
- `codex-overleaf-link-2.3.1.tgz`: npm native host CLI package for pinned install, doctor, and uninstall flows.
- `install.sh`: release-pinned macOS / Linux installer that defaults to `v2.3.1` when run directly from the release artifact.
- `install.ps1`: release-pinned Windows PowerShell installer that defaults to `v2.3.1` when run directly from the release artifact.
...
```bash
npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed
```
...
```bash
CODEX_OVERLEAF_REF=v2.3.1 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.3.1/install.sh)" -- --browser chromium
```

Linux Chromium uninstall:

```bash
npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed --browser chromium
```
...
| Installer/update command | `npm exec --yes codex-overleaf-link@2.3.1 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- install-managed --browser chromium` |
| Uninstall command | `npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-managed --browser chromium` |
...
```bash
npm exec --yes codex-overleaf-link@2.3.1 -- install-native
```

Legacy native-only installations can be removed with:

```bash
npm exec --yes codex-overleaf-link@2.3.1 -- uninstall-native
```
