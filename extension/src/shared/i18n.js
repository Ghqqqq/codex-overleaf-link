(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      queuedInputAttachmentsUnsupported: 'Queued follow-ups support text and @context in v2.1.6. Remove binary attachments before queuing.',
    ...
    zh: {
      ...
      queuedInputAttachmentsUnsupported: 'v2.1.6 的排队消息支持文本和 @context；请先移除二进制附件。',
